    ...
    def download(self, path=None, chunk_size=8*1024,
        ...
        try:
            with open(fullpath, 'wb') as dst_file:
                ...
                print("\nDownloading: '{0}.{1}' (Bytes: {2} | Megabytes: {3:.1f})\n\n".format(
                      self.filename, self.extension, file_size, file_size/1024/1024.0))
                ...
                while True:
                    ...
                    if on_progress:
                        on_progress(self._bytes_received, file_size, file_size/1024/1024.0, start)
